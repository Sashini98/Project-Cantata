						...
						<div className="tile is-ancestor">
							<div className="tile  is-vertical is-8">
									...
									<div className="tile lyricBox is-parent is-vertical">
										<article className="tile is-child is-primary">
											...
											<span className="subtitle halfLyricSection">
												She just wants to be, beautiful She goes, unnoticed she
												knows, no limits She craves, attention she praises, an
												image She prays to be, sculpted by the sculptor Oh, she
												don't see, the light that's shining Deeper than the eyes
												can find it Maybe we have made her blind So she tries to
												cover up her pain And cut her woes away 'Cause
												covergirls don't cry After their face is made But
												there's a hope that's waiting for you in the dark You
												should know you're beautiful just the way you are And
												you don't have to change a thing The world could change
												its heart No scars to your beautiful We're stars and
												we're beautiful
											</span>
										</article>
									</div>
								...
								<div className="tile coversthumbnails is-parent thumbnails">
									...
									<div>
										<button className="coverBtn1" onClick={openModal}>
											Cover 1
											<div className="likeComment">
												<div class="columns">
													<div class="column"></div>
								...
								<article className="tile is-child is-success">
									<div className="content">
										...
										<p className="subtitle">
											Basically, that song is about body image. It's directed at
											women, but I think men can relate to it as well. It's just
											a song about these things that certain women go through on
											a daily basis in order to feel loved or in order to love
											themselves. I think that's such a thing that goes on in
											today's world. These weird things are instilled in us. You
											know? That tell us that we’re not good enough or that
											there's only one kind of beauty. This song basically is
											contradicting that idea. It's saying, 'Well, if the world
											doesn't like how you look then they should change.
										</p>
									</div>
								</article>
								{/* comment section */}
										...
										<details open class="comment" id="comment-1">
											...
											<div class="comment-body">
												<p>
													...
													wrote, and this is sure to help me out in the future.
												...
												<details open class="comment" id="comment-3">
													...
													<div class="comment-body">
														<p>
															...
															standards to be able to enjoy this. Good for you I
															guess, but you should honestly stop making these
													...
													<div class="replies">
														...
														<details open class="comment" id="comment-4">
															...
															<div class="comment-body">
																<p>
																	You are breaking{" "}
																	<a href="#rule-687">Rule #687</a> with that
																	comment. Please avoid posting like this in the
							...
							<div className="tile lyricBox is-parent is-vertical">
								<article className="tile is-child is-primary">
									...
									<p className="subtitle halfLyricSection">
										...
										butterflies I feel in my belly You can be the captain And I
										can be your first mate You can be the chills that I feel on
										our first date You can be the hero And I can be your
										sidekick You can be the tear That I cry if we ever split You
										can be the rain from the cloud when it's stormin' Or u can
										be the sun when it shines in the mornin' Don't know if I
