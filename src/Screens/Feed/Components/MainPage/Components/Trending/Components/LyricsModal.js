...
function LyricsModal(props) {
    ...
    const getComments = () => {
        axios.get("https://gist.githubusercontent.com/AmayaKinivita/adb4786ed6aa2f21974a8be80406430a/raw/e35937df7a3c0cc602f967a480a9fac026fc1aab/comments.json").then(response => {
                ...
                <div className="hero-body pb-4 pt-4 hero-b-o">
                    <div className="columns">
                        <div className="column is-8 is-align-self-center has-text-left">
                            <p className="title is-3 mb-0">{props.selectedRecord.Title || "Song Title"}</p>
                        ...
                        <div className="column is-4 has-text-centered">
                            <img
                                alt="Billing"
                                className="hero-img mb-0"
                                src={user}
                            ></img>
                            <p>User {props.selectedRecord.UserId || ""}</p>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        onSubmit={text => {
                            if (text.length > 0) {
                                setComments([...comments, {
                                    authorUrl: '#',
                                    avatarUrl: 'https://sunrift.com/wp-content/uploads/2014/12/Blake-profile-photo-square.jpg',
                                    createdAt: new Date(),
